...
function(InvoicesFormatter, ResourceModel) {
    ...
    QUnit.test("Should return the Invoice Status", function(assert){
        ...
        //Assert
        assert.strictEqual(fnIsolatedFormatter("A"), "New", "The invoice statos for A is correct");
        assert.strictEqual(fnIsolatedFormatter("B"), "In Progress", "The invoice statos for B is correct");
        assert.strictEqual(fnIsolatedFormatter("C"), "Done", "The invoice statos for C is correct");
    });
});